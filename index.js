...
const CONFIG = {
    ...
    // Exemplo: 'Patrulheiro'
    // Deixe null para qualquer pessoa poder criar ação
...
const CATEGORIAS = {
    ...
    medias: {
        ...
        locais: [
            ...
            {
                value: 'Banco Fleeca Lifeinvader',
                min: 564933,
                max: 584933
            },

            {
                value: 'Banco Fleeca Praia',
                min: 564933,
                max: 584933
            },

            {
                value: 'Banco Fleeca Route 68',
                min: 564933,
                max: 584933
            },

            {
                value: 'Banco Fleeca Chaves',
                min: 564933,
                max: 584933
            },

            {
                value: 'Banco Fleeca Shopping',
                min: 564933,
                max: 584933
            },
...
// Dados temporários enquanto o usuário cria a ação
// chave = ID do usuário
const temp = new Map();
...
function buscarLocal(local) {
    ...
    for (const categoria of Object.values(CATEGORIAS)) {
        ...
        const item = categoria.locais.find(
            l => l.value === local
        );
...
function montarListaParticipantes(
    participantes,
    maxParticipantes
) {
...
function criarEmbedAcao(
    ...
    const embed = new EmbedBuilder()
        ...
        .addFields(
            ...
            },
            {
                name: '🎯 Faixa esperada',
                value:
                    `${formatarReal(data.valorMin)} ` +
                    `- ${formatarReal(data.valorMax)}`,
                inline: false
            },
            {
                name: '👮 Responsável',
    ...
    if (status === 'andamento') {
        ...
        embed.addFields({
            name:
                `👥 Escalados ` +
                `(${data.participantes.length}/${data.maxParticipantes})`,
...
async function atualizarMensagemAcao(
    message,
    data
) {
...
const commands = [
    ...
    new SlashCommandBuilder()
        .setName('painel')
        .setDescription(
            'Envia o painel de criação de ações'
        )
            ...
            if (
                    ...
                    embedCancelado
                        ...
                        .addFields({
                            ...
                            value:
                                ...
                                `❌ **Faltaram:** ${Math.max(faltaram, 0)} pessoa(s)`
                        });
                ...
                if (
                    ...
                    if (canalLog) {
                        ...
                        console.log(
                            '⚠️ Canal de log de ações não encontrado.'
                        );
                    }
